...
const mockProfile = {
  ...
  nfts: [
    { id: 1, name: "Seed Planter", image: "/placeholder.svg?height=100&width=100", rarity: "Common" },
    { id: 2, name: "First Bloom", image: "/placeholder.svg?height=100&width=100", rarity: "Rare" },
    { id: 3, name: "Grove Keeper", image: "/placeholder.svg?height=100&width=100", rarity: "Epic" },
    { id: 4, name: "Innovation Catalyst", image: "/placeholder.svg?height=100&width=100", rarity: "Legendary" },
  ],
}
              ...
              <div className="flex-1 pt-12 md:pt-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-emerald-800/80 max-w-2xl">{mockProfile.bio}</p>
                  </div>
        ...
        <div className="grid gap-4 md:grid-cols-4 mb-8">
          <Card className="border-emerald-100 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-900">{mockProfile.stats.ideasSubmitted}</p>
          ...
          <Card className="border-emerald-100 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-900">{mockProfile.stats.ideasBuilt}</p>
          ...
          <Card className="border-emerald-100 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-900">{mockProfile.stats.votesGiven}</p>
          ...
          <Card className="border-emerald-100 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-900">{mockProfile.stats.currentStreak}</p>
